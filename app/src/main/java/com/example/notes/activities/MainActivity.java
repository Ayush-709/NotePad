...
public class MainActivity extends AppCompatActivity implements NotesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageAddNoteMain = findViewById(R.id.imageAddNoteBtn);
        ...
        findViewById(R.id.quickActionImageAddNote).setOnClickListener(v -> startActivityForResult(
                new Intent(getApplicationContext(), CreateNoteActivity.class),
                REQUEST_CODE_ADD_NOTE
        ));

        findViewById(R.id.quickActionImageAddImage).setOnClickListener(v -> {
        ...
        findViewById(R.id.quickActionImageAddWebLink).setOnClickListener(v -> showAddURLDialog());
    }
