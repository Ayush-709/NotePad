...
public class CreateNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageSave = findViewById(R.id.imageDoneCheck);
    ...
    private void intiMiscellaneous(){
        ...
        BottomSheetBehavior.from(layoutMiscellaneous).setPeekHeight(250);
        ...
        initColors(imageColor1,imageColor2,imageColor3,imageColor4,imageColor5);


        layoutMiscellaneous.findViewById(R.id.viewColor1).setOnClickListener(v -> {
            selectedNoteColor = "#333333";
            imageColor1.setImageResource(R.drawable.ic_check_done);
        ...
        layoutMiscellaneous.findViewById(R.id.viewColor2).setOnClickListener(v -> {
            ...
            imageColor2.setImageResource(R.drawable.ic_check_done);
            imageColor3.setImageResource(0);
            imageColor4.setImageResource(0);
            imageColor5.setImageResource(0);
            setSubtitleIndicatorColor();
        ...
        layoutMiscellaneous.findViewById(R.id.viewColor3).setOnClickListener(v -> {
            ...
            imageColor1.setImageResource(0);
            imageColor2.setImageResource(0);
            imageColor3.setImageResource(R.drawable.ic_check_done);
            imageColor4.setImageResource(0);
            imageColor5.setImageResource(0);
            setSubtitleIndicatorColor();
        });
        layoutMiscellaneous.findViewById(R.id.viewColor4).setOnClickListener(v -> {
            ...
            imageColor2.setImageResource(0);
            imageColor3.setImageResource(0);
            imageColor4.setImageResource(R.drawable.ic_check_done);
            imageColor5.setImageResource(0);
            setSubtitleIndicatorColor();
        });
        layoutMiscellaneous.findViewById(R.id.viewColor5).setOnClickListener(v -> {
            ...
            imageColor3.setImageResource(0);
            imageColor4.setImageResource(0);
            imageColor5.setImageResource(R.drawable.ic_check_done);
            setSubtitleIndicatorColor();
        });
    ...
    private void showDeleteNoteDialog(){
        if(dialogDeleteNote==null){
            ...
            view.findViewById(R.id.textCancelDelete).setOnClickListener(v -> {
    ...
    private void initColors(ImageView imageColor1,ImageView imageColor2,ImageView imageColor3,ImageView imageColor4,ImageView imageColor5){
        imageColor1.setImageResource(R.drawable.ic_check_done);
        imageColor2.setImageResource(0);
        imageColor3.setImageResource(0);
        imageColor4.setImageResource(0);
